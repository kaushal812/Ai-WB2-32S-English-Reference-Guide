...
# --- REQUIRED CHANGES FOR WI-FI CLOCK ---

# 1. Disable Bluetooth components (not needed for the clock)
CONFIG_BT_CENTRAL:=0
...
# 3. Increase Stack Size for the Clock Task (Wi-Fi, SNTP, and Graphics are heavy)
CONFIG_SYS_APP_TASK_STACK_SIZE:=8192

# 4. Define which components should use logging (optional, but good practice)
LOG_ENABLED_COMPONENTS:=blog_testc hosal loopset looprt bloop wifi_clock sntp
